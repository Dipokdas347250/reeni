                ...
                <div className="container">
                    ...
                    <div className=" lg:flex justify-between items-center lg:mt-15 mt-7.5">
                        <div className="lg:w-1/2 w-full">
                            <div className="">
                                <div className="py-8.5 px-9.5 bg-[#f4f4f4] dark:bg-primary rounded-[20px] border-b-3 border-r-3 border-secondary  ">
                            ...
                            <div className="">
                                <div className="py-8.5 px-9.5 bg-[#f4f4f4] dark:bg-primary rounded-[20px] border-b-3 border-r-3 border-secondary mt-5 ">
                   ...
                   <div className="lg:mt-22.5 mt-15">
                    <h2 className='text-[32px] text-primary dark:text-white font-bold font-rajdhani leading-10.5'>Education </h2>
                     <div className=" lg:flex  justify-between items-center mt-8 gap-8">
                        <div className="lg:w-1/2 w-full">
                            <div className="">
                                <div className="py-12 px-9.5 bg-[#f4f4f4] dark:bg-primary rounded-[20px] border-b-2 border-r-2 border-secondary  ">
                            ...
                            <div className="">
                                <div className="py-12 px-9.5 bg-[#f4f4f4] dark:bg-primary rounded-[20px] border-b-2 border-r-2 border-secondary mt-8 ">
