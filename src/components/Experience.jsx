                        ...
                        <div className="lg:w-1/2 w-full">
                            ...
                            after:h-full after:w-full after:top-50 after:left-100 dark:after:bg-secondary after:blur-[90px]  ">
                                <div className=" lg:flex gap-11 items-center ">
                                    <h3 className='lg:text-[167px] text-[100px] text-secondary font-bold font-inter lg:leading-45.75 leading-25 '>25</h3>
                        ...
                        <div className="lg:w-1/2 w-full">
                           <div className="">
                             <div className="lg:flex md:flex justify-between items-center gap-8">
                                <div className="lg:w-1/2 w-full lg:mt-0 mt-8 ">
                                    <div className="py-9 bg-[#f4f4f4] dark:bg-primary rounded-[20px] border-b-3 border-r-3 border-secondary  ">
                                        <h2 className='text-[48px] text-primary dark:text-white font-bold font-inter leading-15.5 text-center'>20k+</h2>
                                ...
                                <div className="lg:w-1/2 w-full lg:mt-0 mt-8 ">
                                    <div className="py-9 bg-[#f4f4f4] dark:bg-primary rounded-[20px] border-b-3 border-r-3 border-secondary  ">
                                        <h2 className='text-[48px] text-primary dark:text-white font-bold font-inter leading-15.5 text-center'>10k+</h2>
                                        <p className='text-[16px] text-tertiary font-normal font-rubik leading-6.5 mt-1 text-center'>Our Natural Products</p>
                            ...
                            <div className="">
                                ...
                                <div className="lg:w-1/2 w-full lg:mt-0 mt-8 ">
                                    <div className="py-9 bg-[#f4f4f4] dark:bg-primary rounded-[20px] border-b-3 border-r-3 border-secondary  ">
                                        <h2 className='text-[48px] text-primary dark:text-white font-bold font-inter leading-15.5 text-center'>200+</h2>
                                        <p className='text-[16px] text-tertiary font-normal font-rubik leading-6.5 mt-1 text-center'>Clients Reviews</p>

                                    </div>
                                </div>
                                <div className="lg:w-1/2 w-full lg:mt-0 mt-8 ">
                                    <div className="py-9 bg-[#f4f4f4] dark:bg-primary rounded-[20px] border-b-3 border-r-3 border-secondary  ">
                                        <h2 className='text-[48px] text-primary dark:text-white font-bold font-inter leading-15.5 text-center'>1,000+</h2>
                                        <p className='text-[16px] text-tertiary font-normal font-rubik leading-6.5 mt-1 text-center'>our Satisfied Clientd</p>
